        ...
        Picker.prototype = {
            ...
            _createPicker: function(customProps) {
                ...
                var itemClickFn = function(e) {
                    ...
                    _self._trigger('pickerPick', {
                        pickerItem: this,
                        pickerValue: _self.pickerValue
                    });
                    if (_self.options.hideOnPick) {
                        _self.hide();
                    }
                };
                ...
                for (var i in this.selectableItems) {
                    ...
                    itemElement.data('pickerValue', this.selectableItems[i]).on('click.picker', itemClickFn);
                    this.picker.element.find('.picker-items').append(itemElement.attr('title', '.' + this.getValue(this.selectableItems[i])));
                }
                ...
                if (this.options.inline === false) {
                    ...
                    var isInsideFn = $.proxy(function(e) {
                        ...
                        if ((!_t.hasClass('picker-element')  ||
                            (_t.hasClass('picker-element') && !_t.is(this.element))) && (_t.parents('.picker-popover').length === 0)) {
                            return false;
                        }
                        return true;
                    }, this);
